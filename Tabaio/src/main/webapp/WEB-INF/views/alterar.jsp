    ...
    <body>
        <div class="container-fluid">
            <div class="btn-group pull-right">
                <form class="btn-group" action="<%= request.getContextPath() %>/agenda" method="GET">
                    <button type="submit" class="btn btn-link">Agenda</button>
                </form>
                <form class="btn-group">
                    <h5> | </h5>
                </form>
                <form class="btn-group" action="<%= request.getContextPath() %>/logout" method="POST">
            ...
            <form action="<%= request.getContextPath() %>/alterar" method="POST">
